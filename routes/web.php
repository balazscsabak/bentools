...
Route::group(['middleware' => ['auth', 'admin']], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('socials', [SettingsController::class, 'settingsSocials'])->name('admin.socials');
        Route::post('socials', [SettingsController::class, 'settingsSaveSocials'])->name('admin.socials.update');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('orders/error/{hash}', [PurchaseController::class, 'showOrderError'])->name('purchase.order.error');
